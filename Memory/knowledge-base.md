...
- Термины: использовать принятые русские слова, не кальки-англицизмы. «гестуры» → «жесты»
  (жесты управления экраном); при необходимости пояснять в скобках «жесты (gestures)»
